...
export class HostTreeDataProvider extends Disposable implements vscode.TreeDataProvider<DataTreeItem> {
    ...
    constructor(
        ...
        this._register(vscode.commands.registerCommand('openremotessh.explorer.resetPassword', e => this.resetPassword(e)));
    ...
    private async resetPassword(element: HostLocationItem) {
        await AuthSettings.instance.delete(element.hostname);
        this.refresh();
    }
